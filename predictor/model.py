...
class PandemicModel:
    ...
    def train_model(self, df, target, feature_names, test_size=0.2):
        """
        ...
        Args:
            ...
            feature_names (list): Liste des noms de colonnes à utiliser comme features.
    ...
    def load_model(self, target):
        """
        Charge le modèle XGBoost sauvegardé pour la cible spécifiée.

        Args:
            target (str): Nom de la colonne cible pour laquelle charger le modèle.
    ...
    def predict_future(self, df, target, feature_names, days_ahead=7, look_back=30):
        ...
        Returns:
            pd.DataFrame: DataFrame contenant les prédictions futures.
        """
